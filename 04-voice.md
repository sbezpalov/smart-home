> **Синхронизация:** Notion **[Voice](https://www.notion.so/35e50b4d7304819e8439e427e3ad4e23)** — первичный источник (импорт **2026-05-15**). Этот файл — зеркало; журнал правок — Notion **[История изменений](https://www.notion.so/35e50b4d730481088390dd76fe648c06)**.
...
> ℹ️ **Эксплуатация моделей.** OpenAI периодически deprecate'ает модели. Проверять `Admin → AI Agents → OpenAI API` после уведомлений OpenAI и хотя бы раз в квартал; кнопка `Pricing` в той же админке ведёт в актуальный список. Замены вносить как запись в Notion **[История изменений](https://www.notion.so/35e50b4d730481088390dd76fe648c06)**.
