> **Синхронизация:** Notion **[mDNS / Bonjour между VLAN 1 и VLAN 10](https://www.notion.so/35f50b4d730481a4bfdde09d6ac5553a)** — первичный источник (импорт **2026-05-15**). ADR-003 — [`06-adr.md`](06-adr.md). Ниже — зеркало таблиц + рабочие заметки сессии **2026-05-13**.

# Apple-стек в VLAN 10, mDNS-bridge и обновление Devices

> ✅ **Notion применён 2026-05-13** (ADR-003, подстраница mDNS, Devices). Блоки 1–3 — историческая запись патча; повторно в Notion **не** вносить.
...
- **Bathhouse (G2H + M1S)** — роли зафиксированы: вся периферия на **M1S** `54EF44322EBA`; **G2H** — только камера (самостоятельный hub). См. [`09-devices.md`](09-devices.md). Остаётся: Zigbee-канал/Pan ID и разнос от второго координатора при соседних mesh.
...
- ~~**Связь Devices ↔ Rooms**~~ — колонки на странице Rooms заполнены **2026-05-18** (git `05-rooms.md` + Notion **Комнаты**).
