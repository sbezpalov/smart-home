> **Синхронизация:** Notion **[Архитектурные решения (ADR)](https://www.notion.so/35e50b4d73048171a965ccf05669e0b2)** — первичный источник (импорт **2026-05-15**). Этот файл — зеркало; при расхождении правьте Notion, затем подтяните сюда. Таблицы mDNS — [`10-apple-iot-fabric.md`](10-apple-iot-fabric.md).
